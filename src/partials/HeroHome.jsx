      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="pt-32 pb-6 md:pt-40 md:pb-10">
          ...
          <div className="text-center pb-6 md:pb-8">
            <h1 className="text-5xl md:text-6xl font-extrabold leading-tighter tracking-tighter mb-4" data-aos="zoom-y-out">Forward for <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-teal-400">FileHelper</span></h1>
